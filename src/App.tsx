...
const ProfileSection = () => {
  return (
    <div className="flex flex-col items-center text-center gap-3 pt-12 pb-2">
      ...
      {/* 
      <div className="mt-2">
        <span className="text-2xl font-bold text-[#3a3028] m-0">技育 太郎</span>
        <p className="text-sm text-[#8a7a6c] mt-0.5">Taro Giiku</p>
      </div>
      <p className="text-sm text-[#6b5744]">技育大学 情報工学科 1年</p>
...
const TagSection = () => {
  ...
  return <Flex direction='row' gap='sm' wrap='wrap' justify='center'>
    <></>
  </Flex>
}
